        ...
        <table data-table="true" class="table table-sm table-hover table-striped table-column-header">
            ...
            <c:forEach items="${model.lista}" var="item">
                <tr>
                    ...
                    <td data-label="OPERACION" id="td${item.id_unidad_medida}">
                        <div class="dropdown">
...
<div class="row">
    <div class="col-xl-2">
        <select class="form-select" id="mostrar" name="mostrar" onchange="cargarElementoUnidadMedida(1)">
    ...
    <div class="col-xl-10">
        <nav aria-label="...">
            <ul class="pagination">
                <c:choose>
                    <c:when test="${model.paginaActual == 1}">
                        <li class="page-item disabled">
                            <a class="page-link" href="javascript:cargarElementoUnidadMedida(1);">Anterior</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
                            <a class="page-link"
                               href="javascript:cargarElementoUnidadMedida(${model.paginaActual-1});">Anterior</a>
                        </li>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    <c:when test="${model.paginaActual == cantidadpaginas}">
                        <li class="page-item disabled">
                            <a class="page-link" href="javascript:cargarElementoUnidadMedida(${cantidadpaginas});">Siguiente</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
                            <a class="page-link"
                               href="javascript:cargarElementoUnidadMedida(${model.paginaActual+1});">Siguiente</a>
                        </li>
                    </c:otherwise>
                </c:choose>
                <li class="page-item">
                    <a class="page-link" href="javascript:cargarElementoUnidadMedida(1);">Primero</a>
                </li>
                    ...
                    <c:choose>
                        <c:when test="${i == model.paginaActual}">
                            <li class="page-item active" aria-current="page">
                                <a class="page-link" href="javascript:cargarElementoUnidadMedida(${i});">${i}</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                ...
                <li class="page-item">
                    <a class="page-link" href="javascript:cargarElementoUnidadMedida(${cantidadpaginas});">Ultimo</a>
                </li>
            </ul>
        </nav>
    </div>
