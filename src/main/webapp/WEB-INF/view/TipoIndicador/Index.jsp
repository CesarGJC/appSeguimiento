...
<main class="app-content3">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Detalle Tipos Indicadores</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="tile border border-primary">
                <div class="tile-title-w-btn">
                    <h3 class="title">Tipos Indicadores</h3>

                </div>
                <div class="tile-body">
                    <button id="addButton" type="button"
                            data-atributes='"id_tipo_indicador": 0'></button>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary border-start-0 border-bottom-0 border ms-n5"
                                        type="button" onclick="cargarElementoTipoIndicador(${model.pagina})"><i
                    ...
                    <div class="row">
                        <div id="table-container" data-toolbar="true" data-add="true"
                             data-url-add="${pageContext.request.contextPath}/tipo-indicador/new"
                             data-url-data="${pageContext.request.contextPath}/tipo-indicador/listar-filtrar"
                             data-url-update="${pageContext.request.contextPath}/tipo-indicador/update"
                             data-url-delete="${pageContext.request.contextPath}/tipo-indicador/delete"
                             class="table-main-container col-xl">
                            <jsp:include page="${request.contextPath}/tipo-indicador/listar">
...
<script>
    ...
    let table = new TableBoostrap(document.getElementById('table-container'), {
        title: "Lista de Tipos de Indicadores",
    ...
    function cargarElementoTipoIndicador(pagina) {
        let params = {
            pagina: pagina,
    ...
    function filtrarResultados(pagina) {
        if (event.keyCode === 13) {
            cargarElementoTipoIndicador(pagina);
        }
    }
