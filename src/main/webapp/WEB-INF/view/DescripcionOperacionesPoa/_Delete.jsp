...
<div class="row">
    <div class="col-md mb-3 mt-3">
        <form:form data-form="true" method="post"  data-target="contenido" modelAttribute="model"
                   action="${pageContext.request.contextPath}/descripcion-operaciones/delete">
            <form:hidden path="id_descripcion_operaciones_poa"/>
            <form:hidden path="id_accion_corto_plazo_poa"/>
            <form:hidden path="id_formulario"/>
            <div class="row">
                <label class="control-label col-md-3">Descripcion Operaciones:</label>
                <div class="col-md-9">
                    <c:out value="${model.descripcion_operaciones_poa}"/>
                </div>
            </div>
        </form:form>
    </div>
