...
<main id="main" data-context="${pageContext.request.contextPath}" class="app-content3">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a class="enlace" href="<c:url value="/areas-estrategicas/index"/>">Areas</a></li>
            <li class="breadcrumb-item"><a class="enlace" href="<c:url value="/catalogo-indicadores/index/${model.id_area_estrategica}"/>">Catalogo</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="tile border border-primary">
                <div class="tile-title-w-btn">
                    <h3 class="title">REGISTRO CATÁLOGO DE INDICADORES DE LA UNIVERSIDAD AUTONOMA DEL BENI "JOSE BALLIVIAN"</h3>
                </div>
                <div class="tile-body">
                    <div class="row">
                        <div class="col">
                        ...
                        <form:form modelAttribute="model" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button data-target="id_unidad_medida" data-url="${pageContext.request.contextPath}/unidad-medida/new" class="btn btn-primary btn-add-item" type="button"><i class="fa fa-plus"></i>
                                    </button>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <form:select path="id_tipo_indicador" cssClass="form-select filter"
                                                 ...
                                                 itemLabel="value" itemValue="id"/>
                                    <button data-target="id_tipo_indicador" data-url="${pageContext.request.contextPath}/tipo-indicador/new" class="btn btn-primary btn-add-item" type="button"><i class="fa fa-plus"></i>
                                    </button>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <form:select path="id_categoria" cssClass="form-select filter"
                                                 ...
                                                 itemLabel="value" itemValue="id"/>
                                    <button  data-target="id_categoria" data-url="${pageContext.request.contextPath}/categoria-indicador/new" class="btn btn-primary btn-add-item" type="button"><i class="fa fa-plus"></i>
                                    </button>
                                </div>
                ...
                <div class="tile-footer">
                    <button class="btn btn-primary btn-enviar-solicitud"  data-name="model" type="button"><i class="bi bi-check-circle-fill me-2"></i>Registrar</button> <a class="btn btn-secondary enlace" href="<c:url value="/catalogo-indicadores/index/${model.id_area_estrategica}"/>"><i class="bi bi-x-circle-fill me-2"></i>Cancelar</a>
                </div>
            </div>
        </div>
    </div>
