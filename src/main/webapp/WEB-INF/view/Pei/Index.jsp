...
<main class="app-content3">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Plan Estrategico Insitucional(P.E.I.)</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="tile border border-primary">
                <div class="tile-title-w-btn">
                    <h3 class="title">Catalogo P.E.I.</h3>
                </div>
                <div class="tile-body">
...
<script src="<c:url value="/static/js/app/pei/index.js"/>"></script>
