            ...
            <div class="col-sm-6">
                <div class="tile border border-primary rounded-3 sombra">
                    ...
                    <div class="tile-body">
                        ...
                        <hr>
                        <div class="mb-5">
                            <a href="<c:url value="/poa/new/${item.id_formulario}"><c:param name="id_programa" value="${model.id_programa}"/><c:param name="id_departamento" value="${model.id_departamento}"/></c:url>"
