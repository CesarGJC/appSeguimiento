...
<main id="main" data-context="${pageContext.request.contextPath}" class="app-content3">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a class="enlace" href="<c:url value="/poa/acceso"/>">Formularios</a>
            </li>
        </ul>
    </div>
                        ...
                        <div class="col-12 table-responsive">
                            <table class="table-formulario">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2">DESCRIPCIÓN DE OPERACIONES</th>
                                    <th rowspan="6">BIEN NORMA O SERVICIO</th>
