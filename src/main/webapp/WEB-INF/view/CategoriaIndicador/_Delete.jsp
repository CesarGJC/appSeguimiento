...
<div class="row">
    <div class="col-md mb-3 mt-3">
        <form:form data-form="true" method="post" modelAttribute="model"  action="${pageContext.request.contextPath}/categoria-indicador/delete">
            ...
            <div class="row">
                <label class="control-label col-md-3">Abreviacion</label>
                <div class="col-md-9">
                    <c:out value="${model.abreviacion}"/>
                </div>
            </div>
        </form:form>
    </div>
