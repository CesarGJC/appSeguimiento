...
<main class="app-content3">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Detalle Objetivos Estrategicos</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="tile border border-primary">
                <div class="tile-title-w-btn">
                    <h3 class="title">Objetivos Estrategicos</h3>

                </div>
                <div class="tile-body">
                    <button id="addButton" type="button"
                            data-atributes='"id_objetivos_estrategicos": 0'></button>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary border-start-0 border-bottom-0 border ms-n5"
                                        type="button" onclick="cargarElementoObjetivosEstrategicos(${model.pagina})"><i
                    ...
                    <div class="row">
                        <div id="table-container" data-toolbar="true" data-add="true"
                             data-url-add="${pageContext.request.contextPath}/objetivos-estrategicos/new"
                             data-url-data="${pageContext.request.contextPath}/objetivos-estrategicos/listar-filtrar"
                             data-url-update="${pageContext.request.contextPath}/objetivos-estrategicos/update"
                             data-url-delete="${pageContext.request.contextPath}/objetivos-estrategicos/delete"
                             class="table-main-container col-xl">
                            <jsp:include page="${request.contextPath}/objetivos-estrategicos/listar">
...
<script>
    ...
    function cargarElementoObjetivosEstrategicos(pagina) {
        let params = {
            pagina: pagina,
    ...
    function filtrarResultados(pagina) {
        if (event.keyCode === 13) {
            cargarElementoObjetivosEstrategicos(pagina);
        }
    }
