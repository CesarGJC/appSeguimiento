...
<div class="row">
    <div class="col-md mb-3 mt-3">
        <form:form data-form="true" method="post" modelAttribute="model"  action="${pageContext.request.contextPath}/formulario/programacion/delete">
            <form:hidden path="id_formulario"/>
            <div class="row">
                <label class="control-label col-md-3">Titulo</label>
                <div class="col-md-9">
                    <c:out value="${model.titulo}"/>
                </div>
            </div>
            <div class="row">
                <label class="control-label col-md-3">Eje</label>
                <div class="col-md-9">
                    <c:out value="${model.eje}"/>
                </div>
            </div>
            <div class="row">
                <label class="control-label col-md-3">Meta</label>
                <div class="col-md-9">
                    <c:out value="${model.meta}"/>
                </div>
            </div>
            <div class="row">
