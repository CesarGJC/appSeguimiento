                    ...
                    <td data-label="OPERACION" id="td${item.id_formulario}">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a href="<c:url value="/programacion/detalle/index/${item.id_formulario}"></c:url>"
                                       class="dropdown-item enlace"><i class="fa fa-id-card-o" ></i> Elaborar programacion</a></li>
                                <li><a href="<c:url value="/formulario/programacion/update"><c:param name="id" value="${item.id_formulario}"/></c:url>"
                                       class="dropdown-item enlace"><i class="fa fa-pencil" ></i>Modificar</a></li>
                                <li>
            ...
            <ul class="pagination">
                ...
                <c:choose>
                    <c:when test="${model.paginaActual == cantidadpaginas}">
                        <li class="page-item disabled">
                            <a class="page-link" href="javascript:cargarElementoCategoriaIndicador(${cantidadpaginas});">Siguiente</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
                ...
                <li class="page-item">
                    <a class="page-link" href="javascript:cargarElementoCategoriaIndicador(${cantidadpaginas});">Ultimo</a>
                </li>
            </ul>
        </nav>
    </div>
