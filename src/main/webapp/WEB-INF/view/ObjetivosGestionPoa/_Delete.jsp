...
<div class="row">
    <div class="col-md mb-3 mt-3">
        <form:form data-form="true" method="post"  data-target="contenido" modelAttribute="model"
                   action="${pageContext.request.contextPath}/objetivo-gestion-poa/delete">
            ...
            <div class="row">
                <label class="control-label col-md-3">Objetivo Gestion:</label>
                <div class="col-md-9">
                    <c:out value="${model.objetivos_gestion_poa}"/>
                </div>
            </div>
        </form:form>
    </div>
