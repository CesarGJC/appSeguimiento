...
<main class="app-content3">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Detalle Politicas de Desarrollo</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="tile border border-primary">
                <div class="tile-title-w-btn">
                    <h3 class="title">Politicas de Desarrollo</h3>

                </div>
                <div class="tile-body">
                    <button id="addButton" type="button"
                            data-atributes='"id_politica_desarrollo": 0'></button>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary border-start-0 border-bottom-0 border ms-n5"
                                        type="button" onclick="cargarElementoPoliticas(${model.pagina})"><i
                    ...
                    <div class="row">
                        <div id="table-container" data-toolbar="true" data-add="true"
                             data-url-add="${pageContext.request.contextPath}/politicas-desarrollo/new"
                             data-url-data="${pageContext.request.contextPath}/politicas-desarrollo/listar-filtrar"
                             data-url-update="${pageContext.request.contextPath}/politicas-desarrollo/update"
                             data-url-delete="${pageContext.request.contextPath}/politicas-desarrollo/delete"
                             class="table-main-container col-xl">
                            <jsp:include page="${request.contextPath}/politicas-desarrollo/listar">
...
<script>
    let table = new TableBoostrap(document.getElementById('table-container'), {
        title: "Lista de Politicas de Desarrollo",
        add: document.getElementById('addButton')
    });

    function cargarElementoPoliticas(pagina) {
        let params = {
            pagina: pagina,
