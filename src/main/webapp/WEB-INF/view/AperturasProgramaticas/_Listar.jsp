    ...
    <div id="datostabla" class="col-xl responsive">
        <table data-table="true" class="table table-sm table-hover table-striped table-column-header">
            ...
            <tr>
                ...
                <th data-resize="true" data-filter="true"
                    data-type="text" data-row-sort="1">CODIGO
                </th>
                <th></th>
            </tr>
            </thead>
            ...
            <c:forEach items="${model.lista}" var="item">
                <tr>
                    ...
                    <td data-label="OPERACION" id="td${item.id_apertura_programatica}">
                        <div class="dropdown">
...
<div class="row">
    <div class="col-xl-2">
        <select class="form-select" id="mostrar" name="mostrar" onchange="cargarElementoAperturas(1)">
    ...
    <div class="col-xl-10">
        <nav aria-label="...">
            <ul class="pagination">
                <c:choose>
                    <c:when test="${model.paginaActual == 1}">
                        <li class="page-item disabled">
                            <a class="page-link" href="javascript:cargarElementoAperturas(1);">Anterior</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
                            <a class="page-link"
                               href="javascript:cargarElementoAperturas(${model.paginaActual-1});">Anterior</a>
                        </li>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    <c:when test="${model.paginaActual == cantidadpaginas}">
                        <li class="page-item disabled">
                            <a class="page-link" href="javascript:cargarElementoAperturas(${cantidadpaginas});">Siguiente</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item disabled">
                            <a class="page-link"
                               href="javascript:cargarElementoAperturas(${model.paginaActual+1});">Siguiente</a>
                        </li>
                    </c:otherwise>
                </c:choose>
                <li class="page-item">
                    <a class="page-link" href="javascript:cargarElementoAperturas(1);">Primero</a>
                </li>
                    ...
                    <c:choose>
                        <c:when test="${i == model.paginaActual}">
                            <li class="page-item active" aria-current="page">
                                <a class="page-link" href="javascript:cargarElementoAperturas(${i});">${i}</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                ...
                <li class="page-item">
                    <a class="page-link" href="javascript:cargarElementoAperturas(${cantidadpaginas});">Ultimo</a>
                </li>
            </ul>
        </nav>
    </div>
