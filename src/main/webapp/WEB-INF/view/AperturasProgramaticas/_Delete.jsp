...
<div class="row">
    <div class="col-md mb-3 mt-3">
        <form:form data-form="true" method="post" modelAttribute="model"  action="${pageContext.request.contextPath}/aperturas-programaticas/delete">
            <form:hidden path="id_apertura_programatica"/>
            <div class="row">
                <label class="control-label col-md-3">Descripcion</label>
                <div class="col-md-9">
                    <c:out value="${model.apertura_programatica}"/>
                </div>
            </div>
            <div class="row">
